...
public class Main {
    public static void main(String[] args) {
        try {
            BufferedReader reader = new BufferedReader(new FileReader("C:\\Users\\mi-20\\OneDrive\\Escritorio\\temporal_spatial-main\\temporal_spatial-main\\python\\dummy_data.csv"));
